...
class SettingController extends GetxController {
	...
	final RxString selectedReminderCadence = 'Today'.obs;
	...
	void setPaymentReminderEnabled(bool value) => paymentReminderEnabled.value = value;
	...
	Future<void> openSupportEmail() async {
		...
		final body = StringBuffer()
			...
			..writeln('App version: ${packageInfo.version} (${packageInfo.buildNumber})')
			...
			..writeln('Currency: ${selectedCurrency.value}')
			..writeln('Reminder: ${paymentReminderEnabled.value ? 'Enabled' : 'Disabled'}')
											...
											child: Row(
												children: [
													...
													if (option == selectedValue)
														const Icon(Icons.check_circle, color: Color(0xFF8A7CFF), size: 20),
												],
											),
										),
									),
